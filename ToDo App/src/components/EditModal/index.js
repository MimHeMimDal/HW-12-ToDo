...
import PutAndRecivetData from "./../../library/PutAndReciveData";
// import { handlePageSelect } from "../PageinationContainer";
            ...
            child: [
              ...
              Button({
                ...
                onclick: (e) => {
                  ...
                  const tempObj = {
                    taskNameInput: editTaskNameInput.value,
                    status: Status.value,
                    priority: Priority.value,
                    dateInput: editDateInput.value,
                    textareaInput: textareaInput.value,
                    id: item.id,
                  };
                  PutAndRecivetData(tempObj, item.id);
